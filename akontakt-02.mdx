...
<CardGroup cols={2}>
  <Card title="1. Příprava na návrat do rodiny">
    Vysoká intenzita, sanace rodiny, typické pro PPPD.
  </Card>

  <Card title="2. Udržení funkčního vztahu">
    Zachování citové vazby tam, kde rodič dlouhodobě spolupracuje.
  </Card>

  <Card title="3. Znovunavázání vztahu po odloučení">
    Aplikace striktního navykacího režimu a postupné gradace.
  </Card>

  <Card title="4. Podpora identity a životního příběhu">
...
<Card title="Pokračovat na další kapitolu" icon="arrow-right" href="/akontakt-03">
