...
Následující autentický modelový příklad detailně ilustruje precizní aplikaci fází krizového řízení v emočně vysoce rizikové a vztahově komplikované situaci.

**Podrobná kazuistika: Asistovaný kontakt desetiletého Tomáše s biologickým otcem (Anamnéza domácího násilí)**

<AccordionGroup>
  <Accordion title="1. Anamnéza a výchozí situace" icon="file-medical">
  ...
  <Accordion title="2. Realizace Fáze 4 (Logistické plánování)" icon="calendar-check">
  ...
  <Accordion title="3. Realizace Fáze 5 (Bezprostřední příprava)" icon="brain">
  ...
  <Accordion title="4. Realizace Fáze 6 (Průběh a krizová intervence na místě)" icon="person-falling-burst">
  ...
  <Accordion title="5. Aktivace krizového protokolu a ukončení kontaktu" icon="bell">
  ...
  <Accordion title="6. Realizace Fáze 7 (Post-kontaktní ošetření a dlouhodobá evaluace)" icon="stethoscope">
  ...
  <Accordion title="7. Následný monitoring v rodině (Fáze 7)" icon="eye">
  ...
  <Accordion title="Procesní vyústění" icon="scale-balanced">
