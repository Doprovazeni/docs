...
<Info>
  **Metodická poznámka:** Tento text není pouhým doslovným přepisem jednoho materiálu, ale představuje komplexní syntézu oficiálního metodického doporučení MPSV ČR k realizaci kontaktů a navazujících prováděcích instrukcí k financování a doprovázení NRP. Kompletní přehled legislativních zdrojů a přímé odkazy na dokumenty MPSV naleznete na konci této stránky.
</Info>
...
import OfficialSources from '/_snippets/zdroje-mpsv-do-kontaktus-rodinou.mdx';
