...
CÍLE REALIZACE KONTAKTŮ (Dle IPOD) ├── 1. Příprava na plánovaný návrat dítěte do původní rodiny │   └── (Vysoká intenzita, sanace rodiny, typické pro PPPD) ├── 2. Udržení stávajícího funkčního vztahu s rodičem │   └── (Zachování citové vazby tam, kde rodič dlouhodobě spolupracuje) ├── 3. Znovunavázání vztahu po dlouhodobém odloučení │   └── (Aplikace striktního navykacího režimu a postupné gradace) └── 4. Podpora identity a zpracování životního příběhu └── (Eliminace fantazií, přijetí reality vlastní historie bez směřování k návratu)
