...
sidebarTitle: "Fáze 1–3: Vyhodnocení a dohoda"
...
## 4.1 Fáze 1: Komplexní vyhodnocení potřeb dítěte a IPOD
...
* **Role doprovázejícího subjektu:** Doprovázející organizace detailně monitoruje reakce dítěte při každém kontaktu a poznatky zapracovává do půlročních zpráv pro OSPOD. V případě náhlé dekompenzace dítěte předává informace okamžitě bez čekání na konec pololetí.
...
<AccordionGroup>
  <Accordion title="Kvalita vztahové vazby (Attachment)" icon="link">
    Zkoumá se, zda má dítě k biologickému rodiči vytvořenou bezpečnou, ambivalentní, nebo dezorganizovanou vazbu. Monitoruje se přítomnost zdravých nebo patologických vzorců chování ze strany rodiče.
  </Accordion>
  <Accordion title="Emoční a psychosociální stabilita" icon="face-smile">
    Sleduje se celkové ladění dítěte, míra úzkosti, prožívání strachu, nebo naopak posílení sebejistoty a pocitu sounáležitosti.
  </Accordion>
  <Accordion title="Fyzické a psychické bezpečí" icon="shield">
    Hodnotí se míra reálných rizik (riziko verbalizované agrese, manipulace, přítomnost toxických osob v okolí rodiče).
  </Accordion>
  <Accordion title="Základní a specifická péče" icon="hand-holding-medical">
    Posuzuje se, zda rodič během kontaktu respektuje věk dítěte, jeho aktuální únavu, stravovací návyky a zdravotní či dietní omezení (např. podávání léků, diabetes).
  </Accordion>
</AccordionGroup>
...
* **Formulář pro vyhodnocování rizik v kontaktu:** Specializovaná matice, která bodově hodnotí specifické behaviorální projevy rodiče a pěstouna před, během a po setkání.
...
Metodické doporučení klade mimořádný, kritický důraz na vyhodnocování a podporu vazeb mezi sourozenci.
...
## 4.2 Fáze 2: Psychologická a vyjednávací příprava aktérů na dohodu
...
## 4.3 Fáze 3: Uzavření Rámcové dohody o kontaktu
...
<Steps>
  <Step title="Časové omezení a flexibilita">
    Žádná dohoda o kontaktu nesmí být uzavřena jako "trvalá a neměnná". Do textu se povinně integruje ustanovení o její **omezené časové platnosti (zpravidla na 3 nebo 6 měsíců)**. Po uplynutí této lhůty se na společné schůzce vyhodnotí dopady na dítě a dohoda se buď prodlouží, nebo upraví.
  </Step>
  <Step title="Písemná forma jako standard">
    Ačkoliv občanský zákoník připouští ústní formu (která funguje u bezproblémových širších příbuzenských vztahů), metodika **důrazně doporučuje formu písemnou**. Písemný dokument podepsaný pěstounem, rodičem a stvrzený klíčovým pracovníkem je nejúčinnější prevencí budoucích interpretačních sporů a nedorozumění.
  </Step>
  <Step title="Integrace krizových scénářů">
    Již v textu rámcové dohody musí být explicitně popsáno, co se stane, pokud jedna ze stran poruší závazky (např. rodič opakovaně bez omluvy nedorazí, pěstoun bezdůvodně zruší termín). Definuje se mechanismus náhradních termínů a bod, kdy se situace eskaluje směrem k OSPOD.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="A. Případová konference" icon="users-rectangle">
    Koordinované, strukturované setkání širšího kruhu odborníků za účasti pěstounů a biologických rodičů (případně i samotného dítěte, pokud je to s ohledem na věk vhodné). Svolavatelem a moderátorem je buď OSPOD, nebo doprovázející organizace, pokud disponuje příslušným zákonným pověřením k výkonu SPOD. Pokud mezi pěstounem a rodičem panuje extrémní emočné napětí, je vysoce účelné vyjednávání rozdělit do několika dílčích, oddělených schůzek (tzv. oddělené vyjednávání) a teprve po uklidnění situace a nalezení shody na klíčových bodech přistoupit ke společné případové konferenci k finálnímu podpisu.
  </Card>

  <Card title="B. Rodinná konference" icon="people-roof">
  ...
  <Card title="C. Profesionální rodinná mediace" icon="scale-balanced">
...
* **NEMÁ AKTIVNÍ LEGITIMACI (Nesmí podat návrh):** OSPOD dítěte ani doprovázející organizace nemohou sam